 ...
 */
final class Version20190507160737 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE wiki (id INT AUTO_INCREMENT NOT NULL, materia_id INT DEFAULT NULL, titulo VARCHAR(255) NOT NULL, cuerpo LONGTEXT NOT NULL, hashtag VARCHAR(255) DEFAULT NULL, INDEX IDX_22CDDC06B54DBBCB (materia_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE alumnos (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(255) NOT NULL, apellidos VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, password TEXT NOT NULL, foto VARCHAR(55) DEFAULT NULL, role VARCHAR(50) NOT NULL, UNIQUE INDEX email (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE recordatorios (id INT AUTO_INCREMENT NOT NULL, categoria_id INT DEFAULT NULL, materia_id INT DEFAULT NULL, alumno_id INT DEFAULT NULL, titulo VARCHAR(255) NOT NULL, descripcion VARCHAR(255) DEFAULT NULL, fecha DATETIME NOT NULL, INDEX IDX_D4A59CFB54DBBCB (materia_id), INDEX IDX_D4A59CFFC28E5EE (alumno_id), INDEX IDX_D4A59CF3397707A (categoria_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE horarios (id INT AUTO_INCREMENT NOT NULL, id_alumno_id INT DEFAULT NULL, hora_inicio TIME NOT NULL, hora_final TIME NOT NULL, dia INT NOT NULL, actividad VARCHAR(255) NOT NULL, INDEX IDX_5433650A7C1D59C9 (id_alumno_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE recursos (id INT AUTO_INCREMENT NOT NULL, materia_id INT DEFAULT NULL, alumno_id INT DEFAULT NULL, tipos_archivo VARCHAR(10) NOT NULL, tamano DOUBLE PRECISION NOT NULL, nombre VARCHAR(255) NOT NULL, INDEX IDX_5163D17DB54DBBCB (materia_id), INDEX IDX_5163D17DFC28E5EE (alumno_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE materias (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE calificaciones (id INT AUTO_INCREMENT NOT NULL, materia_id INT DEFAULT NULL, alumno_id INT DEFAULT NULL, nota DOUBLE PRECISION NOT NULL, ciclo VARCHAR(255) NOT NULL, porcentaje INT DEFAULT NULL, INDEX IDX_41F72CC8B54DBBCB (materia_id), INDEX IDX_41F72CC8FC28E5EE (alumno_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
